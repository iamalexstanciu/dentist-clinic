...
function Home() {
  ...
  return (
    <div className="section" id="home">
      ...
      <Parallax className="parallax-subsection" translateY={["-5%", "20%"]}>
        <div className="subsection">
          <Widget className="widget widget-1">
            <a href="#0" className="learn-more">
              Grijă Preventivă
              <div className="_80-tooth-shine">
                <svg
                  className="union"
                  width="64"
                  height="70"
